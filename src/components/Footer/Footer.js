    ...
    <footer className='footer bg-orange'>
      <div className = "container py-4 text-center">
        <div className='flex align-center justify-center text-white fw-3 fs-14'>
          ...
          <div className='vert-line'></div>
          <Link to = "/" className='text-uppercase'>About All in One.</Link>
        </div>
        <span className='text-white copyright-text text-manrope fs-14 fw-3'>&copy; 2022 All in One Store. All Rights Reserved.</span>
      </div>
    </footer>
  )
}
